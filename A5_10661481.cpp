...
int main(){
	...
	cout<<"Please provide me with the following details about you "<<endl;
	
	for(i=0; i<5; i++){
	cout<<"Student ID"<<"\t"<<"Name"<<"\t"<<"Age"<<"\t"<<"Gender"<<"\t"<<"Score"<<endl;
		cin>> arr[i].std_id>> arr[i].fname>> arr[i].age>> arr[i].gender>> arr[i].score;
		cout<<endl;
	}
	...
	for(i=0; i<5; i++){
		if(arr[i].gender=='m' || 'M'){
			...
			cout<<"Please check your gender"<<endl;
		}
	...
	for(i=0; i<5; i++){
		...
		my_file<<arr[i].std_id<<"\t"<<arr[i].fname<<"\t"<<arr[i].age<<"\t"<<arr[i].gender<<"\t"<<arr[i].score<<"\t"<<arr[i].grade<<endl;
		my_file<<"**************************************************************";
